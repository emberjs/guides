Quando seu aplicativo for iniciado, o roteador compara com a URL com as *rotas* que você definiu. The routes, in turn, are responsible for displaying templates, loading data, and setting up application state.
