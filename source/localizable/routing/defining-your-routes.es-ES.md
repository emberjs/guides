Cuando se inicia tu aplicación, el Router coincide la URL actual a las *rutas* que has definido. The routes, in turn, are responsible for displaying templates, loading data, and setting up application state.
